...
:G4VModularPhysicsList()
{
  ...
  // Low-E EM physics !!! this is already treated in EmStatndardPhysics
...
{
  SetCutsWithDefault();
  G4ProductionCutsTable::GetProductionCutsTable()->SetEnergyRange(100*keV,100*TeV);
/*
  SetCutValue(0*mm, "proton");
  SetCutValue(0*mm, "e-");
  SetCutValue(0*mm, "e+");
  SetCutValue(0*mm, "gamma");
  SetCutValue(0*mm, "muon+");
  SetCutValue(0*mm, "muon-");
  SetCutValue(0*mm, "");
  SetCutValue(0*mm, "");
  SetCutValue(0*mm, "");
